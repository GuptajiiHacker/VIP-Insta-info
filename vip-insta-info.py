...
def banner():
	print("""
"\[\033[0;33m\]"       _              _____           _               _____        __    "\[\033[0;33m\]"   
"\[\033[0;33m\]"/\   /(_)_ __         \_   \_ __  ___| |_ __ _        \_   \_ __  / _| ___  "\[\033[0;33m\]"
"\[\033[0;33m\]"\ \ / / | '_ \ _____   / /\/ '_ \/ __| __/ _` |_____   / /\/ '_ \| |_ / _ \ "\[\033[0;33m\]"
"\[\033[0;33m\]" \ V /| | |_) |_____/\/ /_ | | | \__ \ || (_| |_____/\/ /_ | | | |  _| (_) |"\[\033[0;33m\]"
 "\[\033[0;33m\]" \_/ |_| .__/      \____/ |_| |_|___/\__\__,_|     \____/ |_| |_|_|  \___/ "\[\033[0;33m\]"
  "\[\033[0;33m\]"      |_|                                                                 
